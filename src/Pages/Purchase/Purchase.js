...
const Purchase = () => {
    ...
    const onSubmit = data => {
        ...
        const order = {
            ...
            amount: orderQuantity * tool.price,
            ...
            <div className='my-5 mx-12'>
                <div className="card lg:card-side bg-base-300 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="card-title text-3xl">{tool.name}</h2>
                        <h2 className="card-title">Product ID: {tool._id}</h2>
                        <h2 className="card-title">Price: {tool.price}/Unit</h2>
                        <h2 className="card-title">Available Quantity: {tool.quantity}</h2>
                        <h2 className="card-title">Minimum Order Quantity: {tool.min}</h2>
